...
//   const posts = useLoaderData<BlogList[]>();
  ...
  return (
    ...
    <div className="font-comfortaa">
        <div className="w-full md:text-center pt-8 pb-8 text-xl">
            <strong>Privacy Policy</strong>
    
        </div>
            <div className="text-sm">
            <p className="font-comfortaa"> Hongly Dev built the android app as
                  an Ad Supported app. This SERVICE is provided by
                  Hongly Dev at no cost and is intended for use as
                  is.
                </p> <p className="mt-2">
                  ...
                  Hongly Dev unless otherwise defined in this Privacy Policy.
                </p> <p className="mt-8 mb-4"><strong>Information Collection and Use</strong></p> <p>
                  For a better experience, while using our Service, I
                  may require you to provide us with certain personally
                  identifiable information. The information that
                  I request will be retained on your device and is not collected by me in any way.
                </p> 
                <p className="mt-8 mb-4"><strong>Log Data</strong></p> <p>
                  ...
                  statistics.
                </p> <p className="mt-8 mb-4"><strong>Cookies</strong></p> <p>
                ...
                </p> <p className="mt-8 mb-4"><strong>Service Providers</strong></p> <p>
                  I may employ third-party companies and
                  individuals due to the following reasons:
                </p> <ul className="list-inside mt-2">
                ...
                <p className="mt-2">
                ...
                </p> <p className="mt-8 mb-4"><strong>Security</strong></p> <p>
                ...
                </p> <p className="mt-8 mb-4"><strong>Links to Other Sites</strong></p> <p>
                  ...
                  services.
                </p> <p className="mt-8 mb-4"><strong>Children’s Privacy</strong></p>
                <div><p>
                  ...
                  </p></div> <p className="mt-8 mb-4"><strong>Changes to This Privacy Policy</strong></p> <p>
                  I may update our Privacy Policy from
                  time to time. Thus, you are advised to review this page
                  periodically for any changes. I will
                  notify you of any changes by posting the new Privacy Policy on
                  this page.
                </p> <p className="text-xs mt-4">Last update at 14 August 2023</p>
                 <p className="mt-8 mb-4"><strong>Contact Us</strong></p> 
                <p>If you have any questions or suggestions about my
                  Privacy Policy, do not hesitate to contact me :</p>
                  <p className="mt-4">Email : hongly.developer@gmail.com</p>
